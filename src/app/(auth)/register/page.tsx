...
export default function RegisterPage() {
    ...
    function validate(): boolean {
        ...
        if (password !== confirmPassword) e.confirm = '两次密码不一致';
        setErrors(e);
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            toast.success('注册成功', { description: `欢迎, ${data.username}！已自动登录。` });
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 p-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 p-8">
                    <h2 className="text-lg font-semibold mb-6">创建新账户</h2>
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <Button type="submit" className="w-full h-11 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white shadow-md" disabled={loading}>
